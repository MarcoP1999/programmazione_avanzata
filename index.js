...
console.log("Running on http://".concat(process.env.APPPORT, ":").concat(process.env.APPPORT));
...
var userCnt = new UserController();
...
app.get("/user", auth.checkUser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
